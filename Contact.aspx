<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="demo3.Contact" %>
					...
					<!--	<form method="post" action="#"> -->
							<fieldset>
								...
								<!--	<label for="name"><span>Name:</span></label> -->
									<asp:Label ID="Label1" for="name" runat="server" Text="Name:"></asp:Label>
									<div class="input">
									<!--	<input tabindex="1" size="18" id="name" name="name" type="text" value="" class="input-xlarge" placeholder="Name"> -->
										<asp:TextBox ID="txtname" runat="server" tabindex="1" size="18"  name="name" type="text" value="" class="input-xlarge" placeholder="Name"></asp:TextBox>
									</div>
								</div>
								
								<div class="clearfix">
									<!--<label for="email"><span>Email:</span></label>-->
									<asp:Label for="email" ID="Label2" runat="server" Text="Email:"></asp:Label>
									<div class="input">
										<!--<input tabindex="2" size="25" id="email" name="email" type="text" value="" class="input-xlarge" placeholder="Email Address"> -->
										<asp:TextBox ID="txtemail" runat="server" tabindex="2" size="25"  name="email" type="text" value="" class="input-xlarge" placeholder="Email Address"></asp:TextBox>
									</div>
								</div>
								
								<div class="clearfix">
								<!--	<label for="message"><span>Message:</span></label> -->
									<asp:Label ID="Label3" runat="server" for="message" Text="Message:"></asp:Label>
									<div class="input">
									<!--	<textarea tabindex="3" class="input-xlarge" id="message" name="body" rows="7" placeholder="Message"></textarea> -->
										<asp:TextBox ID="txtmess" tabindex="3" class="input-xlarge"  name="body" rows="7" placeholder="Message" runat="server"></asp:TextBox>
										</div>
								</div>
								
								<div class="actions">
								<!--	<button tabindex="3" type="submit" class="btn btn-inverse">Send message</button>-->
									<asp:Button ID="Button1" runat="server" tabindex="3" type="submit" class="btn btn-inverse" Text="Send Message" OnClick="Button1_Click" />
								</div>
							</fieldset>
					<!--	</form> -->
					</div>				
